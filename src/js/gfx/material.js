...
export class Material {
    constructor(gl, vs, fs) {
        this.gl = gl
        this.program = createShaderProgram(this.gl, vs, fs)
    }
}
...
export class Sprite {
    ...
    setup() {
        ...
        gl.bufferData(gl.ARRAY_BUFFER, Sprite.createRectArray(0, 1, 1, -1), gl.STATIC_DRAW)
    ...
    render() {
        if (this.isLoaded) {
            ...
            gl.vertexAttribPointer(this.aTexcoordLoc, 2, gl.FLOAT, gl.FALSE, 0, 0)

            gl.bindBuffer(gl.ARRAY_BUFFER, this.geo_buff)
            gl.enableVertexAttribArray(this.aPositionLoc)
            gl.vertexAttribPointer(this.aPositionLoc, 2, gl.FLOAT, gl.FALSE, 0, 0)
